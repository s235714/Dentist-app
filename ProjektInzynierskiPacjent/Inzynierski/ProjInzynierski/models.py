...
class Pacjent(db.Entity):
    ...
    nr_karty = Optional(int, unique=True, nullable=True)
    higiena = Optional(str, nullable=True)
    zgryz = Optional(str, nullable=True)
    blona_sluzowa = Optional(str, nullable=True)
    uzup_protet = Optional(str, nullable=True)
    przyzebie = Optional(str, nullable=True)
    choroby = Optional(str, nullable=True)
    leki = Optional(str, nullable=True)
    uczulenia = Optional(str, nullable=True)
